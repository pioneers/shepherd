...
buttons = [
    ...
    InputPin(arduino2, 6, PinMode.DIGITAL_IN, make_button_handler(4)),
    InputPin(arduino2, 4, PinMode.DIGITAL_IN, make_button_handler(5)),

    InputPin(arduino3, 8, PinMode.DIGITAL_IN, make_button_handler(6)),
    InputPin(arduino3, 6, PinMode.DIGITAL_IN, make_button_handler(7)),
    InputPin(arduino3, 4, PinMode.DIGITAL_IN, make_button_handler(8)),
    
    InputPin(arduino4, 8, PinMode.DIGITAL_IN, make_button_handler(9)),
    InputPin(arduino4, 6, PinMode.DIGITAL_IN, make_button_handler(10)),
    InputPin(arduino4, 4, PinMode.DIGITAL_IN, make_button_handler(11)),
]
