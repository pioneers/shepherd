...
CHALLENGE_RESULTS[4] = [True] * 8
CHALLENGE_RESULTS[40] = [False, True, False, True, True, True, True, False]
CHALLENGE_RESULTS[2] = [True] * 8
CHALLENGE_RESULTS[15] = [True, False, True, True, True, False, False, False]
