...
tmux send-keys -t 'Shepherd:0.0' 'python3 -m ydl -a 0.0.0.0 -p 5001' Enter
tmux send-keys -t 'Shepherd:0.1' 'python3 live_coding.py' Enter
tmux send-keys -t 'Shepherd:0.2' 'python3 shepherd.py' Enter
tmux send-keys -t 'Shepherd:0.3' 'python3 server.py' Enter
tmux send-keys -t 'Shepherd:0.4' 'python3 whack_a_mole.py' Enter
tmux send-keys -t 'Shepherd:0.5' 'python3 sensors_config.py' Enter
